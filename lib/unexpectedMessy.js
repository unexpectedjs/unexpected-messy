...
function expectMessageToSatisfy(expect, subject, value) {
    ...
    try {
        if (value && typeof value === 'object' && !value.isMessyMessage) {
            ...
            if ('rawBody' in value) {
                expect(subject, 'to have raw body satisfying', value.rawBody);
            }
            if ('text' in value) {
...
module.exports = {
    ...
    installInto: function unexpectedMessy(expect) {
        ...
        .addType({
            ...
            try {
                expect(Object.create(subject, {isMessyHttpRequest: {value: false}}), 'to [exhaustively] satisfy', messageValue);
            ...
            try {
                ...
                expect(Object.create(subject, {isMessyHttpResponse: {value: false}}), 'to [exhaustively] satisfy', messageValue);
            } catch (e) {
                if (e._isUnexpected) {
                    var that = this;
                    e.createDiff = function (output, diff, inspect, equal) {
