...
module.exports = {
    ...
    installInto: function unexpectedMessy(expect) {
        ...
        expect.addAssertion('messyHeaders', 'to [exhaustively] satisfy', function (expect, subject, value) {
            if (isRegExp(value)) {
        ...
        expect.addAssertion('messyMessage', 'to [exhaustively] satisfy', function (expect, subject, value) {
        ...
        expect.addAssertion('messyMessage', 'to have raw body satisfying', function (expect, subject, value) {
            expect(subject.rawBody, 'to satisfy', value);
        });

        expect.addAssertion('messyMessage', 'to have unchunked body satisfying', function (expect, subject, value) {
            expect(subject.unchunkedBody, 'to satisfy', value);
        });

        expect.addAssertion('messyMessage', 'to have file name satisfying', function (expect, subject, value) {
            expect(subject.fileName, 'to satisfy', value);
        });

        expect.addAssertion('messyMessage', 'to have text satisfying', function (expect, subject, value) {
        ...
        expect.addAssertion('messyMessage', '[not] to have number of parts', function (expect, subject, value) {
        ...
        expect.addAssertion('messyRequestLine', 'to satisfy', function (expect, subject, value) {
            if (typeof value === 'undefined') {
                value = {};
                ...
                expect.fail({
                    diff: function (output, diff, inspect, equal) {
                        ...
                        if (messy.RequestLine.propertyNames.some(function (propertyName) {
                            ...
                            output.error('// should satisfy ').append(inspect(value));
                        } else {
        ...
        expect.addAssertion('messyHttpRequest', 'to [exhaustively] satisfy', function (expect, subject, value) {
            if (typeof value === 'undefined') {
                value = {};
        ...
        expect.addAssertion('messyStatusLine', 'to satisfy', function (expect, subject, value) {
            if (typeof value === 'undefined') {
                value = {};
            } else if (typeof value === 'string') {
        ...
        expect.addAssertion('messyHttpResponse', 'to [exhaustively] satisfy', function (expect, subject, value) {
            if (typeof value === 'undefined') {
                value = {};
            } else if (typeof value === 'string' || (typeof Buffer === 'function' && Buffer.isBuffer(value))) {
        ...
        expect.addAssertion('messyHttpExchange', 'to [exhaustively] satisfy', function (expect, subject, value) {
            if (typeof value === 'undefined') {
                value = {};
            }
            var flags = this.flags,
        ...
        expect.addAssertion('messyHttpConversation', '[not] to have number of exchanges', function (expect, subject, value) {
            expect(subject.exchanges, '[not] to have length', value);
        });

        expect.addAssertion('messyHttpConversation', 'to [exhaustively] satisfy', function (expect, subject, value) {
            if (typeof value === 'undefined') {
                value = {};
            } else if (typeof value === 'string' || (typeof Buffer === 'function' && Buffer.isBuffer(value))) {
