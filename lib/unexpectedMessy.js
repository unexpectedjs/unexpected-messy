...
module.exports = function unexpectedMessy(expect) {
    ...
    .addType({
        ...
        inspect: function (output, httpRequest, inspect, depth) {
            ...
            output.append(this.baseType.inspect(output.clone(), httpRequest, inspect, depth)); //MJMMMMMMMMMMM
            return output;
        },
        diff: function (output, actual, expected, diff, inspect, equal) {
            output
        ...
        inspect: function (output, httpResponse, inspect, depth) {
            ...
            output.append(this.baseType.inspect(output.clone(), httpResponse, inspect, depth)); // HMMMMMMMMMMMM
            return output;
        },
        diff: function (output, actual, expected, diff, inspect, equal) {
            output
        ...
        inspect: function (output, httpExchange, inspect, depth) {
            return (
                output
                    .append(inspect(httpExchange.request, depth))
                    .nl(2)
                    .append(inspect(httpExchange.response, depth))
            );
        },
        diff: function (output, actual, expected, diff, inspect, equal) {
            output
