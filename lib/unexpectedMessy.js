...
module.exports = {
    ...
    installInto: function unexpectedMessy(expect) {
        ...
        .addType({
            ...
            if (typeof value === 'string' || (typeof Buffer === 'function' && Buffer.isBuffer(value))) {
                    ...
                    e.createDiff = function (output, diff, inspect, equal) {
                        function inspectSatisfySpecAsInstance(obj, Constructor) {
                            ...
                            if (obj instanceof Constructor) {
                                ...
                                instance = new Constructor(function traverse(obj, path) {
                                    ...
                                    } else if (obj && typeof obj === 'object' && !obj.isMessyHeaders && !obj.isMessyMessage && !obj.isMessyHttpExchange && Object.prototype.toString.call(obj) !== '[object RegExp]') {
                                        var result = {};
                        ...
                        for (var i = 0 ; i < Math.max(subject.exchanges.length, numValueExchanges) ; i += 1) {
                            ...
                            if (i < subject.exchanges.length && i < numValueExchanges) {
                                ...
                                output.annotationBlock(function () {
                                    this.error('should be removed:').nl().append(inspectSatisfySpecAsInstance(subject.exchanges[i], messy.HttpExchange));
                                });
                            }
                        }
                        return { diff: output };
