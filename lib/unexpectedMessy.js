        ...
        expect.addStyle('messyMessageBody', function (message, depth) {
            ...
            if (message.isMultipart) {
                ...
                if (typeof upgradedBody === 'string') {
                    ...
                    if ((typeof Buffer !== 'undefined' && Buffer.isBuffer(upgradedBody)) && /^(?:audio|video|image)$/.test(majorContentType) && this.raw) {
                        this.raw({
                            html: {
                                width: 0,
                                height: 0,
                                content: function () {
                                    ...
                                    if (typeof URL !== 'undefined' && typeof URL.createObjectURL === 'function' && typeof Blob !== 'undefined') {
                                        src = URL.createObjectURL(new Blob([upgradedBody], { type: sanitizeContentType(contentType) }));
                                    } else {
                                        src = 'data:' + sanitizeContentType(contentType) + ';base64,' + upgradedBody.toString('base64');
                                    }
                                    if (majorContentType === 'image') {
                                        return '<img src="' + src + '">';
                                    } else {
                        ...
                        diff: function (output, diff, inspect, equal) {
                            output.block(function (output) {
                                ...
                                var bodySatisfyError = promiseByKey.body.isRejected() && promiseByKey.body.reason(),
                                    bodyDiffResult = bodySatisfyError && bodySatisfyError.getDiff(output);
                                ...
                                if (promiseByKey.fileName && promiseByKey.fileName.isRejected()) {
                                    ...
                                    var d = fileNameError.getDiff(output);
                                    if (d) {
                                ...
                                if (promiseByKey.text && promiseByKey.text.isRejected()) {
                                    ...
                                    output.nl().annotationBlock(function () {
                                        ...
                                        var d = textError.getDiff(output);
                                        if (d) {
                                            output.nl().append(d.diff);
                                        }
                                    });
                                ...
                                if (promiseByKey.rawBody && promiseByKey.rawBody.isRejected()) {
                                    ...
                                    output.nl().annotationBlock(function () {
                                        ...
                                        var d = rawBodyError.getDiff(output);
                                        if (d) {
                                ...
                                if (promiseByKey.unchunkedBody && promiseByKey.unchunkedBody.isRejected()) {
                                    ...
                                    output.nl().annotationBlock(function () {
                                        ...
                                        var d = unchunkedBodyError.getDiff(output);
                                        if (d) {
                                            this.nl().append(d.diff);
                                        }
                                    });
                        ...
                        diff: function (output, diff, inspect, equal) {
                            output.block(function (output) {
                                ...
                                if (promiseByKey.requestLine.isRejected()) {
                                    ...
                                    diffResult = requestLineError.getDiff(output);
                                    if (diffResult) {
                                    ...
                                    diffResult = requestLineSpecError.getDiff(output);
                                    if (diffResult) {
                                        output.append(diffResult.diff);
                                    } else {
                                ...
                                if (promiseByKey.message.isRejected()) {
                                    ...
                                    diffResult = messageError.getDiff(output);
                                    if (diffResult) {
                                        output.append(diffResult.diff);
                                    } else {
                        ...
                        diff: function (output, diff, inspect, equal) {
                            output.block(function (output) {
                                ...
                                if (promiseByKey.statusLine.isRejected()) {
                                    ...
                                    diffResult = statusLineError.getDiff(output);
                                    if (diffResult) {
                                        output.append(diffResult.diff);
                                    } else {
                                    ...
                                    diffResult = statusLineSpecError.getDiff(output);
                                    if (diffResult) {
                                        output.append(diffResult.diff);
                                    } else {
                        ...
                        diff: function (output, diff, inspect, equal) {
                            output.block(function (output) {
                                ...
                                if (promiseByKey.request.isRejected()) {
                                    ...
                                    diffResult = requestError.getDiff(output);
                                    if (diffResult) {
                                        output.append(diffResult.diff);
                                    } else {
                                ...
                                if (promiseByKey.response.isRejected()) {
                                    ...
                                    diffResult = responseError.getDiff(output);
                                    if (diffResult) {
                                        output.append(diffResult.diff);
                                    } else {
