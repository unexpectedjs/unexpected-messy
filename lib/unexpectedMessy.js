...
module.exports = function unexpectedMessy(expect) {
    ...
    .addType({
        ...
        inspect: function (output, httpRequest, inspect) {
            ...
            output.nl();
            inspectMessage(output, httpRequest, inspect);
            return output;
        }
        ...
        inspect: function (output, httpResponse, inspect) {
            ...
            output.nl();
            inspectMessage(output, httpResponse, inspect);
            return output;
        }
        ...
        expect(httpConversation.exchanges.length, 'to equal', value.exchanges.length);
    });
};
