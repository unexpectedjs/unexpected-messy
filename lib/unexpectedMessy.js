        ...
        expect.addStyle('messyMessageBody', function (message, depth) {
            ...
            if (message.isMultipart) {
                ...
                if (typeof upgradedBody === 'string') {
                    ...
                    if (this.format === 'html' && (typeof Buffer !== 'undefined' && Buffer.isBuffer(upgradedBody)) && /^(?:audio|video|image)$/.test(majorContentType) && this.raw) {
                        this.image(upgradedBody, sanitizeContentType(contentType));
                    } else {
